...
- prima ho cominciato a usare un kernel più recente, poi uno custom per il supporto ai [futex](https://man7.org/linux/man-pages/man2/futex.2.html),
...
Poi, con l'anno nuovo e un tempismo che definirei mefistofelico, Virtualbox ha cominciato a rompersi a ogni aggiornamento... Prima il kernel più recente non è supportato e faccio il downgrade, poi lo patchano ma rompono la compatibilità con le versioni precedenti.  
...
## Il nuovo inizio[^5]
Era già da un po' che tenevo d'occhio Fedora e mi frullava in testa l'idea di passare a una distro _rpm-based_ per avere maggior uniformità con le RHEL / CentOS che uso al lavoro. Così mi sono
