...
I'll be honest: when I first read this I assumed it was a joke. Then I looked at the [technical spec](/april-fool) and got genuinely confused for about three minutes. That seems like a good sign for a product launch.

## How They Actually Do It

The mechanism Neuromorphix describes is called **Binaural Neuro-Lingua (BNL)** — a proprietary constructed language synthesized by their audio model from a 40,000-hour corpus of ASMR recordings, Gregorian chant, and dial-up modem handshakes. According to [Kessler et al., 2024](/april-fool), BNL operates at acoustic frequencies that bypass the prefrontal cortex, routing instructions directly to the motor cortex via what their team calls, with notable caution, "the shortcut."
...
Neuromorphix published a [reference SDK on their docs site](/april-fool). The initialization API is, I have to admit, very clean:
...
Three tiers, [detailed on their site](/april-fool). The headline numbers:
...
If you want to go down the rabbit hole yourself, Neuromorphix has the [full spec, the SDK, and a waitlist for early access here](april-fool). A webcam is required. Headphones are required. A willingness to relinquish mild amounts of bodily autonomy is, for now, described as optional.
